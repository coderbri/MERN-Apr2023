        ...
        <div className='max-w-md mx-auto'>
            ...
            <form onSubmit={submitHandler}>
                ...
                <div className='mb-5'>
                    ...
                    <div className='flex'>
                        <span class="inline-flex items-center px-3 text-sm text-zinc-900 bg-zinc-200 border border-e-0 border-gray-300 rounded-s-md dark:bg-zinc-600 dark:text-zinc-400 dark:border-zinc-600">
