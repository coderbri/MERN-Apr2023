...
const CreateAlbumForm = () => {
    ...
    const submitHandler = (e) => {
        e.preventDefault();
        // console.log("Data to be sent:", album);
    ...
    return (
        <div className='max-w-md mx-auto'>
            <h2 className="text-center text-3xl font-bold my-3">Create a New Album</h2>
            ...
            <form onSubmit={submitHandler}>
                ...
                <div className="mb-5">
                    ...
                    <div>
                        <input type="text" name='albumName' onChange={ changeHandler } value={ album.albumName }
                            ...
                            bg-zinc-800 focus:border-emerald-500 focus:ring-emerald-400'
                ...
                <div className="mb-5">
                    ...
                    <div>
                        <select name='genre' onChange={changeHandler} value={album.genre} className='text-sm rounded-lg block w-full p-2.5
                            bg-zinc-800 focus:border-emerald-500 focus:ring-emerald-400'
                        required>
